...
const InputFormSkillRisorsa = ({ title, name, className, skillsRisorse }: Props) => {
        ...
        <div>
            ...
            <div className='relative'>
                      <select
                        ...
                        defaultValue=""
                    >
                        <option value="" disabled>Risorsa</option>
                        {skillsRisorse.length > 0 ? (
                            skillsRisorse.map((skillsRisorse) => (
                                <option key={skillsRisorse.id} value={skillsRisorse.resource.name}>{skillsRisorse.resource.name}</option>
                            ))
                        ) : (
...
export default InputFormSkillRisorsa;
