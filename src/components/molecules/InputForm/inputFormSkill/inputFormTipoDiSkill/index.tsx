...
const InputFormTipoDiSkill = ({ title, name, className, skill }: Props) => {
        ...
        <div>
            ...
            <div className='relative'>
                      <select
                        ...
                        defaultValue=""
                    >
                        <option value="" disabled>Tipo di Skill</option>
                        {skill.length > 0 ? (
                            skill.map((skill) => (
                                <option key={skill.id} value={skill.name}>{skill.name}</option>
                            ))
                        ) : (
                            <option value="" disabled>Nessun tipo di Skill disponibile</option>
                        )}
                    </select>
...
export default InputFormTipoDiSkill;
