        ...
        <table className="w-full divide-gray-100">
            <thead>
                <tr>
                    ...
                    <th className="text-left px-4 py-2">Fattura di acquisto</th>
            ...
            <tbody>
                {currentFatturaAcquistoAttivita.map((fatturaAcquistoAttivita, index) => (
                    <tr key={fatturaAcquistoAttivita.id} className={`${index % 2 === 0 ? 'bg-gray-100 ' : ''}`}>
                        ...
                        <td className="text-left px-4 py-2">{fatturaAcquistoAttivita.activityId}</td>
                        <td className="text-left px-4 py-2">{fatturaAcquistoAttivita.jobId}</td>
