...
const Attività = ()=>{
    ...
    const columnHeaders = [
        { title: 'Id', width: 'px-32' },
        { title: 'Data inizio', width: 'px-32' },
        { title: 'Data fine', width: 'px-32' },
        { title: 'Ore lavorate', width: 'px-10' },
        { title: 'stato', width: 'px-10' },
        { title: 'Commessa', width: 'px-10' },
        { title: 'Ordine', width: 'px-10' },
        { title: 'Risorsa', width: 'px-10' },
        { title: 'Note', width: 'px-10' },
